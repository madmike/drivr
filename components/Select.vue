<template>
  <Listbox as="div" v-model="selected" @update:modelValue="changeValue">
    <div class="relative">
...
const selected = ref(props.options.find(o => o.id === props.selected) || props.options[0]);
const changeValue = (value: { id: string; value: string} ) => emit('change-value', value);
</script>